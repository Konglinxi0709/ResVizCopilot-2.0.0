...
async def create_root_problem(body: ProblemRequest):
    try:
        return await db.add_root_problem(body, publish_message_callback=pm.publish_patch)
...
async def update_root_problem(problem_id: str, body: ProblemRequest):
    try:
        return await db.update_root_problem(problem_id, body, publish_message_callback=pm.publish_patch)
...
async def delete_root_problem(problem_id: str):
    try:
        return await db.delete_root_problem(problem_id, publish_message_callback=pm.publish_patch)
    except KeyError as e:
...
async def create_solution(problem_id: str, body: SolutionRequest):
    try:
        return await db.create_solution(problem_id, body, publish_message_callback=pm.publish_patch)
    except KeyError as e:
...
async def delete_solution(solution_id: str):
    try:
        return await db.delete_solution(solution_id, publish_message_callback=pm.publish_patch)
    except KeyError as e:
...
async def update_solution(solution_id: str, body: SolutionRequest):
    try:
        return await db.update_solution(solution_id, body, publish_message_callback=pm.publish_patch)
    except KeyError as e:
...
async def set_selected_solution(problem_id: str, body: SetSelectedSolutionRequest):
    try:
        return await db.set_selected_solution(problem_id, body.solution_id, publish_message_callback=pm.publish_patch)
    except KeyError as e:
