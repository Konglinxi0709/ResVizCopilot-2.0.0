...
from .retry_wrapper import NetworkError, TimeoutError, APIError
from .message_models import Patch
...
class DeepSeekClient:
    ...
    async def stream_generate(self, 
        ...
        try:
            ...
            # 处理流式响应
            full_content = await self._process_stream_response(response, message_id)
    ...
    async def _process_stream_response(self, response, message_id: str) -> str:
        """
        处理流式响应
